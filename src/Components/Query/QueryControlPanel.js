  ...
  render = () => {
    return (
      <Paper className={this.props.classes.paper}>
        <Typography variant="h4">Fatality Query</Typography>
        <form
        ...
        >
          ...
          <div className={this.props.classes.pageSize}>
            <Typography id="query-control-panel-page-size" gutterBottom>
        ...
        <Typography variant="body1">
          TODO. This will eventually display the data in a more user friendly
          format. For now, I've created this tool for colloborators to get a
          sense of the available data.
        </Typography>
      </Paper>
    );
  };
